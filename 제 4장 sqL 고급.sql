...
insert into `Member` values ('a107', '정철', '010-1234-1007',  '차창', '103',2020-11-19 );
...
select count(*) as `갯수` from `saeles`;

select substring(`hp`,10, 4) as `전화번호 끝자리` from `Member`;
insert into `Member` values ('b101', '을지문덕', '010-5555-1234', '사장', now());
